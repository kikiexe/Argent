        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              <div className="h-6 w-36 bg-canvas-soft rounded animate-pulse" />
              <div className="h-8 w-24 bg-canvas-soft rounded-full animate-pulse" />
            </div>
              ...
              {[1, 2, 3, 4, 5].map((idx) => (
                <div key={idx} className="flex items-center justify-between py-4 px-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-2">
                      <div className="h-3 w-32 bg-canvas-soft rounded animate-pulse" />
                      <div className="h-2.5 w-48 bg-canvas-soft rounded animate-pulse" />
                    </div>
                  </div>
